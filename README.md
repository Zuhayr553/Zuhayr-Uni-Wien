# Demo Application - Zuhayr - Uni Wien

This Flutter project showcases a clean architecture approach with Riverpod for state management, internationalization, and utilization of hooks for enhanced widget management. The architecture used is Riverpod architectur with a controller-service-repo pattern. Below is an overview of the project structure, features, and setup instructions.
...
Here you can watch a video demonstration of the project:

[![Watch the video](https://img.icons8.com/material-outlined/24/000000/play-button-circled.png)](https://drive.google.com/file/d/1lAPjAUz5vwLIpZwHqAFf-VmvRAvOoUnA/view?usp=sharing) [Watch the video](https://drive.google.com/file/d/1lAPjAUz5vwLIpZwHqAFf-VmvRAvOoUnA/view?usp=sharing)
